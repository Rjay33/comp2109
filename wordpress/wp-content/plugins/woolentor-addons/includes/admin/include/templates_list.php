<div class="httemplates-templates-area">
    <div class="httemplate-row">
        ...
        <div class="httemplate-top-banner-area">
            <div class="htbanner-content">
                <div class="htbanner-desc">
                    ...
                    <?php
                        $alltemplates = sizeof( Woolentor_Template_Library::instance()->get_templates_info()['templates'] ) ? sizeof( Woolentor_Template_Library::instance()->get_templates_info()['templates'] ) : 0;
                    ?>
        ...
        <?php if( Woolentor_Template_Library::instance()->get_templates_info()['templates'] ): ?>
            ...
            <ul id="tp-grid" class="tp-grid">
                ...
                <?php foreach ( Woolentor_Template_Library::instance()->get_templates_info(false)['templates'] as $httemplate ): 
