...
// Creates Food Reviews Custom Post type
// function food_reviews_init() - Here we create a new function for our custom post type.  We do this to limit conflicts with any other code inside our function.php file.  It is also a best practice when adding new code to any file like functions.php
...
function food_reviews(){
	$query = new WP_Query( array('post_type' => 'food-reviews', 'posts_per_page' => 10 ) );
...
function food_shortcode(){
	add_shortcode('food_shortcode', 'food_reviews');
}
add_action( 'init', 'food_shortcode');
